...
func main() {
	// We’ll start with a simple command that takes
	// no arguments or input and just prints something to stdout.
	...
	// running a command, waiting for it to finish, and collecting its output.
	...
	// write some input to it, read the resulting output, and finally wait for the process to exit.
